...
WARM_MB=64 INIT_MS=2000 bash hotpod.sh all 2>&1 | grep -E 'RESULT|ERROR'

echo
echo "=== lazy stability x5 (32MB) ==="
for i in 1 2 3 4 5; do
    WARM_MB=32 INIT_MS=1200 bash hotpod.sh lazy >/tmp/r$i.log 2>&1
    rc=$?
...
WARM_MB=16 INIT_MS=800 bash hotpod.sh eager >/tmp/re.log 2>&1
